...
if choice == 'left':
    ...
    if choice == 'wait':
        choice = input("ou arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?").lower()
        if choice == 'blue':
